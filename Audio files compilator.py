...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
       ...
       #self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        ...
        self.github.setGeometry(QtCore.QRect(450, 10, 91, 31))
        self.github.setObjectName("github")
        self.github.setFont(QtGui.QFont("SansSerif",12))
        ...
        self.resetbt.setGeometry(QtCore.QRect(550, 10, 91, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.github.setText(_translate("MainWindow", "Link"))
...
class MyWin(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
       ...
       #palette = QPalette()
        ...
        self.ui.github.clicked.connect(self.internet)
    ...
    def getsongs(self):
        try:
            if self.ganr != '' and self.temp != '':
                self.songs=[]
                self.ui.scr1.clear()
                #print(os.getcwd()+'\\' + self.ganr + '\\' + self.temp)
    ...
    def playmusic(self):
        if(self.flag==0):
            try:
                ...
                self.player.setPlaylist(self.songs)
                self.player.play()
                '''
                mixer.music.stop()
                ...
                '''for i in range (selitem,len(self.songs)):
                    print(self.songs[i])
                    mixer.music.load(u''+self.songs[i])
                    mixer.music.play()'''
...
- Чтобы сохранить Вашу песню,нажмите кнопку Save и выберите папку, где будет хранится пеня
